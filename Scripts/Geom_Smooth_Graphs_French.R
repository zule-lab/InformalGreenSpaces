...
labeled_falaise_smooth_plot_F <- falaise_subset_F %>% #plotting the graph 
  ...
  geom_label_repel(data = falaise_sm_max_F, aes(y=smooth, label= round(smooth,1), fill = factor(Park), size = 5), fontface = 'bold', color = 'white', show.legend = F) + 
...
#ggsave("Falaise_Smooth_Plot_FRENCH.tiff", plot=labeled_falaise_smooth_plot_F, path = "Graphics", dpi = 600, width = 25, height = 15, units = "cm")
...
MHM_subset_F <- subset(summarized_F, Park == "MHM" | Park == "MHM_Reference")
...
labeled_MHM_smooth_plot_F <- MHM_subset_F %>% 
  ...
  geom_label_repel(data = MHM_sm_max_F, aes(y=smooth, label= round(smooth,1), fill = factor(Park), size = 5), fontface = 'bold', color = 'white', show.legend = F) + 
  theme_classic(base_size = 15) + 
  labs(x= "Date (Mois)", y= " Température Moyenne Quotidienne (°C)") +
  theme(axis.title.x = element_text(vjust = -1.5), axis.title.y = element_text(vjust = 2),
        legend.position = "bottom", legend.background = element_rect("white"), legend.title = element_blank(), 
...
#ggsave("MHM_Smooth_Plot_FRENCH.tiff", plot=labeled_MHM_smooth_plot_F, path = "Graphics", dpi = 600, width = 25, height = 15, units = "cm")
...
CdesP_subset_F <- subset(summarized_F, Park == "CdesP" | Park == "CdesP_Reference")
...
labeled_CdesP_smooth_plot_F <- CdesP_subset_F %>% 
  ...
  geom_label_repel(data = CdesP_sm_max_F, aes(y=smooth, label= round(smooth,1), fill = factor(Park), size = 5), fontface = 'bold', color = 'white', show.legend = F) + 
  theme_classic(base_size = 15) + 
  labs(x= "Date (Mois)", y= " Température Moyenne Quotidienne (°C)") +
  theme(axis.title.x = element_text(vjust = -1.5), axis.title.y = element_text(vjust = 2),
        legend.position = "bottom", legend.background = element_rect("white"), legend.title = element_blank(), 
...
#ggsave("CdesP_Smooth_Plot_FRENCH.tiff", plot=labeled_CdesP_smooth_plot_F, path = "Graphics", dpi = 600, width = 25, height = 15, units = "cm")
...
TP_subset_F <- subset(summarized_F, Park == "TP" | Park == "TP_Reference")
...
labeled_TP_smooth_plot_F <- TP_subset_F %>% 
  ggplot(combined, mapping = aes(Date, meanT, group = Park, color = Park)) +
  geom_smooth(method = "loess", span=.55, se=F, linewidth=2.5) +  
  geom_label_repel(data = TP_sm_max_F, aes(y=smooth, label= round(smooth,1), fill = factor(Park), size = 5), fontface = 'bold', color = 'white', show.legend = F) + 
  theme_classic(base_size = 15) + 
  labs(x= "Date (Mois)", y= " Température Moyenne Quotidienne (°C)") +
  theme(axis.title.x = element_text(vjust = -1.5), axis.title.y = element_text(vjust = 2),
        legend.position = "bottom", legend.background = element_rect("white"), legend.title = element_blank(), 
...
#ggsave("TP_Smooth_Plot_FRENCH.tiff", plot=labeled_TP_smooth_plot_F, path = "Graphics", dpi = 600, width = 25, height = 15, units = "cm")
