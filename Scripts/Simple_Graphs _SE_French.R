...
falaise_subset_F <- subset(edited_temp_data_F, Park == "Falaise" | Park == "Falaise_Reference")
...
#ggsave("Falaise_SimpleSE_Plot_FRENCH.tiff", plot=falaise_simpleSE_plot_F, path = "Graphics", dpi = 600, width = 15, height = 20, units = "cm")
...
#ggsave("Falaise_SimpleSE_AllSensors_Plot_FRENCH.tiff", plot=falaise_simpleSE_allsensors_plot_F, path = "Graphics", dpi = 600, width = 20, height = 25, units = "cm")
...
MHM_subset_F <- subset(edited_temp_data_F, Park == "MHM" | Park == "MHM_Reference") 
...
#ggsave("MHM_SimpleSE_Plot_FRENCH.tiff", plot=MHM_simpleSE_plot_F, path = "Graphics", dpi = 600, width = 15, height = 20, units = "cm")
...
#ggsave("MHM_SimpleSE_AllSensors_Plot_FRENCH.tiff", plot=MHM_simpleSE_allsensors_plot_F, path = "Graphics", dpi = 600, width = 20, height = 25, units = "cm")
...
CdesP_subset_F <- subset(edited_temp_data_F, Park == "CdesP" | Park == "CdesP_Reference") 
...
#ggsave("CdesP_SimpleSE_Plot_FRENCH.tiff", plot=CdesP_simpleSE_plot_F, path = "Graphics", dpi = 600, width = 15, height = 20, units = "cm")
...
#ggsave("CdesP_SimpleSE_AllSensors_Plot_FRENCH.tiff", plot=CdesP_simpleSE_allsensors_plot_F, path = "Graphics", dpi = 600, width = 20, height = 25, units = "cm")
...
TP_subset_F <- subset(edited_temp_data_F, Park == "TP" | Park == "TP_Reference") 
...
#ggsave("TP_SimpleSE_Plot_FRENCH.tiff", plot=TP_simpleSE_plot_F, path = "Graphics", dpi = 600, width = 20, height = 25, units = "cm")
...
#ggsave("TP_SimpleSE_AllSensors_Plot_FRENCH.tiff", plot=TP_simpleSE_allsensors_plot_F, path = "Graphics", dpi = 600, width = 20, height = 25, units = "cm")
